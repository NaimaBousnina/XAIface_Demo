...
with second_container:
    ...
    with col2:   
       ...
       ####################################################################################################
            ...
            st.markdown("<h5 style='text-align: center; color: Black; font-size:24px; margin-top: 200px; '>No face beautification or face coding is applied</h5>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: center; color: Black; font-size:24px; margin-top: 90px; '>😔</h5>", unsafe_allow_html=True)
