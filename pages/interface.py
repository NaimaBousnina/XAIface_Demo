...
with first_container:
    ...
    with col2:
        ...
        with contain_1:
            st.markdown(f"<h6 style='margin-top: 60px; text-align: center;float:left; margin-left: 150px; width: 210px; height: 40px; line-height: 40px; color:white;font-size:18px; font-family: Sans-Serif; background-color:DarkBlue; border-radius: 5px 5px;'> Face Verification Tool </h6> <h6 style='margin-top: 60px; text-align: center; float:right;width: 130px; height: 40px; line-height: 40px; color:Black;font-size:18px; font-family: Sans-Serif; background-color:Aqua; border-radius: 5px 5px; margin-right:130px;'>{recognition_tool}</h6>", unsafe_allow_html=True)
        with contain_3:
            st.markdown(f"<h6 style='margin-top: 30px; text-align: center;float:left; margin-left: 150px; width: 210px; height: 40px; line-height: 40px; color:white;font-size:18px; font-family: Sans-Serif; background-color:DarkBlue; border-radius: 5px 5px;'> Decision Threshold </h6> <h6 style='margin-top: 30px; text-align: center; float:right;width: 130px; height: 40px; line-height: 40px; color:Black;font-size:18px; font-family: Sans-Serif; background-color:Aqua; border-radius: 5px 5px; margin-right:130px;'>{decision_thresh}</h6>", unsafe_allow_html=True)
...
with second_container:
    ...
    with col2:   
        ...
        if choise == "Face Coding" and select_coding != "Select": 
            ...
            with container_12:
                st.markdown(f"<h6 style='margin-top: 5px; text-align: center;float:left; margin-left: 40px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#556B2F; border-radius: 5px 5px;'> PSNR-YUV </h6> <h6 style='margin-top: 5px; text-align: center; float:right;width: 120px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#808000; border-radius: 5px 5px; margin-right:40px;'>{PSNR_YUV}</h6>", unsafe_allow_html=True)
            with container_13:
    ...
    with col3:
       ...
       ####################################################################################################
        with container_10:
            ...
            st.markdown(f"<h6 style='margin-top: 30px; text-align: center;float:left; margin-left: 10px; width: 180px; height: 40px; line-height: 40px; color:Black; font-size:18px; font-family: Sans-Serif; background-color:#87CEFA; border-radius: 5px 5px;'> Type of Decision </h6><h6 style='margin-top: 30px; text-align: center;float:right; margin-right: 10px; width: 180px; height: 40px; line-height: 40px; color:Black; font-size:18px; font-family: Sans-Serif; background-color:#87CEFA; border-radius: 5px 5px;'> {deci_type} </h6>", unsafe_allow_html=True)
        with container_11:
            if deci_type == "True Positive" or deci_type == "False Positive" or deci_type == "??":
                st.markdown(f"<h6 style='margin-top: 10px; text-align: center;float:left; margin-left: 10px; width: 180px; height: 40px; line-height: 40px; color:Black; font-size:18px; font-family: Sans-Serif; background-color:#87CEFA; border-radius: 5px 5px; outline: 2px solid #0000FF;'> Similarity Map </h6><h6 style='margin-top: 10px; text-align: center;float:right; margin-right: 10px; width: 180px; height: 40px; line-height: 40px; color:#A9A9A9; font-size:18px; font-family: Sans-Serif; background-color:#87CEFA; border-radius: 5px 5px;'> Dissimilarity Map </h6>", unsafe_allow_html=True)  
        ...
        st.markdown("<h6 style='margin-left: 20px; margin-right: 20px; margin-top: 115px; background-color:#E0FFFF; border-radius: 10px 10px; height: 110px; outline: 2px solid #AFEEEE;'><p style='margin-top: 5px; text-align: justify;margin-left: 15px; margin-right: 15px; font-size:21px; color: Black;'>Highlights the face regions contributing to the face verification decision.</p></h6>", unsafe_allow_html=True)
