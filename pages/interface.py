...
with second_container:
    ...
    with col1:
        ...
        with container_2:
            st.markdown(f"<h6 style='margin-top: 60px; text-align: center;float:left; margin-left: 30px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#556B2F; border-radius: 5px 5px;'> Cosine Distance </h6> <h6 style='margin-top: 60px; text-align: center; float:right;width: 120px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#808000; border-radius: 5px 5px; margin-right:55px;'>{ori_score}</h6>", unsafe_allow_html=True)
        with container_4:
            st.markdown(f"<h6 style='margin-top: 50px; text-align: center;float:left; margin-left: 30px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#556B2F; border-radius: 5px 5px;'> Type of Pair </h6> <h6 style='margin-top: 90px; text-align: center; float:right;width: 120px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#808000; border-radius: 5px 5px; margin-right:55px;'>{comparison_type}</h6>", unsafe_allow_html=True)
        with container_5:  
            st.markdown(f"<h6 style='margin-top: 90px; text-align: center;float:left; margin-left: 30px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#556B2F; border-radius: 5px 5px;'> Verification Decision </h6> <h6 style='margin-top: 90px; text-align: center; float:right;width: 120px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#808000; border-radius: 5px 5px; margin-right:55px;'>{ori_decision}</h6>", unsafe_allow_html=True)  
