...
with second_container:
    ...
    with col2:   
        ...
        if choise == "Face Coding" and select_coding != "Select": 
            ...
            with container_9:
                st.markdown(f"<h6 style='margin-top: 1px; text-align: center;float:left; margin-left: 40px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#556B2F; border-radius: 5px 5px;'> Verification Decision </h6> <h6 style='margin-top: 1px; text-align: center; float:right;width: 120px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#808000; border-radius: 5px 5px; margin-right:40px;'>{coding_decision}</h6>", unsafe_allow_html=True)  

            with container_12:
                st.markdown(f"<h6 style='margin-top: 10px; text-align: center;float:left; margin-left: 40px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#556B2F; border-radius: 5px 5px;'> PSNR-YUV </h6> <h6 style='margin-top: 10px; text-align: center; float:right;width: 120px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#808000; border-radius: 5px 5px; margin-right:40px;'>{PSNR_YUV}</h6>", unsafe_allow_html=True)
            with container_13:
                st.markdown(f"<h6 style='margin-top: 10px; text-align: center;float:left; margin-left: 40px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#556B2F; border-radius: 5px 5px;'>  MS-SSIM </h6> <h6 style='margin-top: 10px; text-align: center; float:right;width: 120px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:#808000; border-radius: 5px 5px; margin-right:40px;'>{MS_SSIM}</h6>", unsafe_allow_html=True)      

            st.markdown("<h3 style=' margin-top: 100px;'></h3>", unsafe_allow_html=True)
