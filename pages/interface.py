...
with second_container:
    ...
    with col3:
       ...
       ####################################################################################################
        ...
        st.markdown("<h6 style='margin-left: 20px; margin-right: 20px; margin-top: 90px; background-color:#E0FFFF; border-radius: 10px 10px; height: 80px; outline: 2px solid #AFEEEE;'><p style='margin-top: 10px; text-align: justify;margin-left: 15px; margin-right: 15px; font-size:21px; color: Black;'>Highlights the face regions contributing to the face verification decision.</p></h6>", unsafe_allow_html=True)
