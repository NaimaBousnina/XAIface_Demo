...
with first_container:
    ...
    with col2:
        ...
        with contain_1:
            st.markdown(f"<h6 style='margin-top: 50px; text-align: center;float:left; margin-left: 150px; width: 210px; height: 40px; line-height: 40px; color:White;font-size:18px; font-family: Sans-Serif; background-color:DarkBlue; border-radius: 5px 5px;'> Face Verification Tool </h6> <h6 style='margin-top: 50px; text-align: center; float:right;width: 130px; height: 40px; line-height: 40px; color:Black;font-size:18px; font-family: Sans-Serif; background-color:Aqua; border-radius: 5px 5px; margin-right:120px;'>{recognition_tool}</h6>", unsafe_allow_html=True)
        with contain_3:
