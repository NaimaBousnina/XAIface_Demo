...
def create_widgets(df, create_data={}, ignore_columns=[], on_change=None):
    ...
    global all_widgets
    all_widgets = []
    st.sidebar.markdown("<h3 style='text-align: center; color: White; margin-left: -15.5px; margin-right: -15.5px; font-size:22px; font-family: Sans-Serif; background-color:Black; height: 50px; line-height: 30px;'>Settings</h3>", unsafe_allow_html=True)
