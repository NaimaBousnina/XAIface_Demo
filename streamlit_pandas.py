...
def create_widgets(df, create_data={}, ignore_columns=[], on_change=None):
    ...
    st.sidebar.markdown("<h3 style='text-align: center; color: White; margin-left: -25px; margin-right: -25px; font-size:35px; font-family: Sans-Serif; background-color:Black; height: 60px; line-height: 30px; padding: 70px 0;'>Settings</h3>", unsafe_allow_html=True)
