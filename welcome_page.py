...
st.markdown("<h5 style='margin-left:45px; text-align: center;  color: black; font-size:20px; margin-top: 40px; margin-bottom: -100px; font-family: Sans-Serif; '>If the screen components are misplaced, please adjust the screen scaling to 100% or 125% </h5>", unsafe_allow_html=True)
